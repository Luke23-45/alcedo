  ...
  return (
    <LegendList
      ...
      contentContainerStyle={{
        ...
        paddingBottom: insets.bottom + theme.layout.screenPadding,
      }}
    />
  );
}
...
function SectionHeader(props: { label: string; count: number }) {
  const theme = useAppTheme();
  return (
    <View style={{ flexDirection: 'row', alignItems: 'center', gap: theme.space.sm, paddingTop: theme.space.xs }}>
...
function FollowersEmpty() {
  ...
  return (
    <Card mode="contained">
      <Card.Content>
        <EmptyInfo icon="personAdd" style={{ paddingVertical: theme.space.base }}>
