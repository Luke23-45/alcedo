...
export const ActivityWeekCell = memo(function ActivityWeekCell({ cell, entrance }: ActivityWeekCellProps) {
  ...
  const { background } = levelColor(cell.level, theme);
    ...
    >
      <View
        style={{
          ...
          backgroundColor: cell.level === 0 ? theme.color.background.elevated : background,
          borderColor: cell.isToday ? theme.color.interactive.tint : 'transparent',
