...
export const ActivityDayCell = memo(function ActivityDayCell({
  ...
  const { background, foreground } = levelColor(cell.level, theme);
              ...
              {visibleMarkers.map((marker) => (
                <View
                  ...
                  style={{
                    ...
                    height: MARKER_SIZE,
                    borderRadius: 1000,
                    backgroundColor: markerColor(marker.userId, theme),
                  }}
                />
              ))}
              {hasOverflow && (
                <SurfaceText
                  ...
                  style={{
                    ...
                    color: isEmpty ? theme.color.content.secondary : foreground,
                  }}
                >
                  {`+${overflowCount}`}
                </SurfaceText>
