...
const lightColors: SemanticColors = {
  ...
  content: {
    ...
    onAccent: '#FFFFFF', // on accent #C93806 → 5.18:1
    onTint: '#FFFFFF', // on tint   #B92403 → 6.33:1
  },
  interactive: {
    tint: palette.ember[700],      // #B92403 — 6.33:1 on white, 5.74:1 on background.secondary
    tintPressed: palette.ember[800], // #8F1D05
    accent: '#C93806',             // dedicated literal, NOT palette.ember[650] — see note below
    accentPressed: palette.ember[700], // #B92403
    accentBright: palette.ember[500], // unchanged — graphics only, still fails AA as a fill/text
...
const darkColors: SemanticColors = {
  ...
  content: {
    ...
    onAccent: '#FFFFFF', // accent stays #C93806 across modes → 5.18:1
    onTint: '#02040A', // on tint #FF8A1E → 8.69:1 — pinned to ink[1000], not content.inverse
  },
  interactive: {
    tint: palette.ember[400],      // #FF8A1E — 8.69:1 on background.base, 7.09:1 on elevated
    // Pressed brightens in dark mode, same direction as accentPressed below.
    tintPressed: palette.ember[300], // #FFAE3C
    accent: '#C93806',             // same literal as light — fill-vs-white contrast doesn't change by mode
  ...
  status: {
    ...
    // Was base #FFC24A — byte-identical to palette.ember[300], now interactive.tintPressed.
    // Pushed to true gold (H47°) for hue separation from the orange tint family.
    warning: { base: '#F0C52A', content: '#F6D65C', surface: 'rgba(240, 197, 42, 0.14)', border: 'rgba(240, 197, 42, 0.32)' },
