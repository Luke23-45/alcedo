...
// docs copy is for reference + EAS currently expects symlink outside app which breaks.
// Keep both: docs/ for publishing and module's own resources/ for Android Gradle codegen (EAS-safe)
...
createSplitSchemas(
  ...
  join(__dirname, '../modules/workout-worker/android/src/main/resources/schema'),
);
