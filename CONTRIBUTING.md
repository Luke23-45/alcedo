...
If you find a bug, please [open an issue](https://github.com/Luke23-45/alcedo/issues) and provide as much detail as possible.
If you have a feature request, please search through [discussions](https://github.com/Luke23-45/alcedo/discussions) to see if it has been suggested, and if not submit a new discussion.
