...
import { mongoContext, postgresContext, type ProviderContext } from './harness';
...
function runAll(provider: string, setup: () => Promise<ProviderContext>): void {
  describe(`repository parity — ${provider}`, () => {
