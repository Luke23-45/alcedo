...
Download [`create-liftlog-plan.zip`](https://github.com/Luke23-45/alcedo/releases/download/plan-builder-skill/create-liftlog-plan.zip), then go to **Customize → Skills → + → Upload a skill** and pick it.
